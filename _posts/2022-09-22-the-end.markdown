...
I have explained the EDRReader's functionality in more detail in the [MDAnalysis User Guide](https://mdanalysisuserguide--220.org.readthedocs.build/en/220/formats/auxiliary.html#edr-files)
...
# Outcome:
[Pyedr](https://pypi.org/project/panedr/) and the [EDRReader](https://docs.mdanalysis.org/2.4.0-dev0/documentation_pages/auxiliary/EDR.html) are now available to make the life of GROMACS users easier. They allow users to more quickly and conveniently verify that their simulations are properly equilibrated without the writing of intermediate files. The [MDAnalysis User Guide](https://mdanalysisuserguide--220.org.readthedocs.build/en/220/formats/auxiliary.html#edr-files) contains a step-by-step guide of how to use the EDRReader and explains the functionality it has.
